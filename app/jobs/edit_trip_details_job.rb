class EditTripDetailsJob < ApplicationJob
  queue_as :default
    ...
    if true
      ...
      response = client.chat(
        parameters: {
            ...
            messages: [{ role: "user", content: trip.edit_prompt(changes)}], # Required.
            temperature: 0.5,
        })
      trip.update(response: response.dig("choices", 0, "message", "content"))
    else
